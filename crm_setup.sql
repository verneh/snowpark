...
CREATE OR REPLACE VIEW crm_dashboard_view as
 ...
 -- create a stream to check for updates.
 CREATE OR REPLACE STREAM crm_dashboard_stream ON VIEW crm_dashboard_view;

 SELECT * FROM crm_dashboard_view;